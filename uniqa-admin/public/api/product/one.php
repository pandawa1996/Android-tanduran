        ...
        if(!empty($setting)){
            ...
            if($id){
                ...
                if($user_id) {
                    ...
                    if($ordered) $response_product->create_property("ordered", 1);
                ...
                if(!empty($product)) {
                    ...
                    $interested_products = $interested_products->where(["category"=>$product->category])->orderBy("sell")->limit(0, API_PAGINATION)->all();
